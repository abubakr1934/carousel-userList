    ...
    <div class="w-full sm:w-8/12 mb-10">
      <div class="container mx-auto h-full sm:p-10">
        ...
        <header class="container px-4 lg:flex mt-10 items-center h-fit lg:mt-0 bg">
          <div class="w-full">
            <h1 class="text-4xl lg:text-6xl font-bold"><span class="text-white">UserList-</span>Discover, Reward, and Review with us!</h1>
            ...
            <button class="bg-white text-black text-2xl font-medium px-4 py-2 rounded shadow">Learn More</button>
          </div>
        </header>
      </div>
    </div>
