...
const Features = () => {
  return (
    <section className="min-h-screen bgg text-center py-20 px-8 xl:px-0 flex flex-col justify-center ">
      <span className="text-white text-lg max-w-lg mx-auto mb-2 capitalize flex items-center">
        what we're offering
        <svg
      ...
      <div className="grid-offer text-left grid sm:grid-cols-2 md:grid-cols-2 gap-5 max-w-5xl mx-auto">
        <div className={`${styles.card} bg-white p-10 relative`}>
          ...
          <div className="relative lg:pr-52">
            <h2 className={`${styles.h2} capitalize text-black mb-4 text-2xl xl:text-3xl`}>
